...
<body>
    ...
    <div class="header_section">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="login_menu">
                <a href="{{asset('template')}}/#"><img src="{{asset('template')}}/images/search-icon.png"></a>
            </div>
        </nav>
        <!-- banner section end -->
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <h1 class="banner_taital">DA FAR <span style="color: #f3801f;">MASI</span></h1>
                                </div>
                                <div class="col-md-6">
                                <widht= 5%>
                                    <div><img src="{{asset('template')}}/images/foto7.jfif" class="image_jfif"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="play_icon"><a href="#"><img src="{{asset('template')}}/images/play-icon.png"></a></div>
        </div>
        <!-- banner section end -->
    </div>
    <!-- header section end -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="about_main">
                                    <h1 class="about_taital">Apotek Kesehatan</h1>
                                    <p class="about_text">Erratic season like today makes the body susceptible to disease. Therefore, take care of your health by regularly consuming vitamins every day. Get the right vitamins for your body at the West Jakarta Pharmacy. Come in person or pre-order via WhatsApp
                                    </p>
                                    <div class="readmore_bt"><a href="#">Read More</a></div>
                                </div>
                            </div>
                            <div class="col-md-6 ">
                                <div class="image_2"><img src="{{asset('template')}}/images/img-4.jpg"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="about_main">
                                    <h1 class="about_taital">Product</h1>
                                    <p class="about_text">It is a long established fact that a reader will be It is a
                                        long
                                        established fact that a reader will be It is a long established fact that a
                                        reader will be
                                    </p>
                                    <div class="readmore_bt"><a href="#">Read More</a></div>
                                </div>
                            ...
                            <div class="col-md-5 ">
                                <div class="produk"><img src="{{asset('template')}}/images/produk.jfif"></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="about_main">
                                    ...
                                    <div class="readmore_bt"><a href="#">Testimoni</a></div>
                                </div>
                            </div>
                            <div class="col-md-6 ">
                                <div class="testimoni"><img src="{{asset('template')}}/images/testimoni."></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box_main active">
                            <div class="left_main">
                                <div class="cup_img_1"><img src="{{asset('template')}}/images/cup-img-1.png"></div>
                            </div>
                        ...
                        <div class="box_main">
                            <div class="left_main">
                                <div class="cup_img_1"><img src="{{asset('template')}}/images/cup-img-2.png"></div>
                            </div>
                            <div class="middle_main">
                        ...
                        <div class="box_main">
                            <div class="left_main">
                                <div class="cup_img_1"><img src="{{asset('template')}}/images/cup-img-3.png"></div>
                            </div>
                            <div class="middle_main">
                                <div class="border_10"></div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="box_main">
                            <div class="left_main">
                                <div class="cup_img_1"><img src="{{asset('template')}}/images/cup-img-4.png"></div>
                            </div>
                            <div class="middle_main">
                                <div class="border_10"></div>
                            </div>
                        ...
                        <div class="box_main">
                            <div class="left_main">
                                <div class="cup_img_1"><img src="{{asset('template')}}/images/cup-img-5.png"></div>
                            </div>
                            <div class="middle_main">
                                <div class="border_10"></div>
                            </div>
    ...
    <div class="choose_section">
        <div class="container">
            ...
            <p class="choose_text">It is a long established fact that a reader will beIt is a long established fact that
                a
                reader will be</p>
            <div class="choose_section_2">
                <div class="choose_left">
                    <div class="choose_left_main">
                        <div class="icon_1"><img src="{{asset('template')}}/images/icon-1.png"></div>
                    </div>
                ...
                <div class="choose_middle">
                    <div class="choose_left_main">
                        <div class="icon_1"><img src="{{asset('template')}}/images/icon-2.png"></div>
                    </div>
                    <div class="choose_right_main">
                ...
                <div class="choose_middle_1">
                    <div class="choose_left_main">
                        <div class="icon_1"><img src="{{asset('template')}}/images/icon-3.png"></div>
                    </div>
                    <div class="choose_right_main">
                ...
                <div class="choose_right">
                    <div class="choose_left_main">
                        <div class="icon_1"><img src="{{asset('template')}}/images/icon-4.png"></div>
                    </div>
                    <div class="choose_right_main">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="container">
                        ...
                        <p class="shop_text">It is a long established fact that a reader will beIt is a long established
                            fact
                            that a reader will be</p>
                        <div><img src="{{asset('template')}}/images/img-3.png" class="image_3"></div>
                    </div>
                </div>
                <div class="carousel-item">
                    <div class="container">
                    ...
                    <div class="accordion" id="accordionExample">
                            ...
                            <div class="card-header" id="headingOne">
                                <h2 class="mb-0">
                                    <button type="button" class="btn btn-link w-100" data-toggle="collapse"
                                        data-target="#collapseOne"><i class="fa fa-plus"></i>Where can I get
                                        some?</button>
                                </h2>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingThree">
                                <h2 class="mb-0">
                                    <button type="button" class="btn btn-link collapsed w-100" data-toggle="collapse"
                                        data-target="#collapseThree"><i class="fa fa-plus"></i>Where does it come
                                        from?</button>
                                </h2>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingThree">
                                <h2 class="mb-0">
                                    <button type="button" class="btn btn-link collapsed w-100" data-toggle="collapse"
                                        data-target="#collapseThree"><i class="fa fa-plus"></i>What is Lorem
                                        Ipsum?</button>
                                </h2>
                            </div>
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                        ...
                        <div class="card">
                            <div class="card-header" id="headingThree">
                                <h2 class="mb-0">
                                    <button type="button" class="btn btn-link collapsed w-100" data-toggle="collapse"
                                        data-target="#collapseThree"><i class="fa fa-plus"></i>Why do we use
                                        it?</button>
                                </h2>
                            </div>
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="container">
                        ...
                        <div class="client_img"><img src="{{asset('template')}}/images/client-img.png"></div>
        ...
        <div class="container">
            <div class="newsletter_section">
                <div class="newsletter_left">
                    <div class="footer_logo"><img src="{{asset('template')}}/images/footer-logo.png"></div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="addres_link">
                            <ul>
                                <li><a href="#"><img src="{{asset('template')}}/images/map-icon.png"><span class="padding_left_10">No.123
                                            Chalingt
                                            Gates</span></a></li>
                                <li><a href="#"><img src="{{asset('template')}}/images/call-icon.png"><span class="padding_left_10">+01
                                            1234567890</span></a></li>
                                <li><a href="#"><img src="{{asset('template')}}/images/mail-icon.png"><span
