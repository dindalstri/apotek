            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="nonota_jual">Nonota_Jual</label>
                        <input type="text" class="form-control
@error('nonota_jual') is-invalid @enderror" id="nonota_jual" placeholder="Nonota_Jual" name="nonota_jual"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('users')  is-invalid  @enderror"
                                placeholder="Users" id="users" name="users" value="{{old('users')}}" aria- label="Users"
